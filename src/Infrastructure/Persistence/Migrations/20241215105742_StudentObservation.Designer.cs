...
namespace SkorinosGimnazija.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241215105742_StudentObservation")]
    partial class StudentObservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ObservationTypeStudentObservation", b =>
                {
                    b.Property<int>("StudentObservationsId")
                        .HasColumnType("integer");

                    b.Property<int>("TypesId")
                        .HasColumnType("integer");

                    b.HasKey("StudentObservationsId", "TypesId");

                    b.HasIndex("TypesId");

                    b.ToTable("ObservationTypeStudentObservation");
                });
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Observation.ObservationLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Observation.ObservationTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ObservationTargets");
                });

            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Observation.ObservationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Observation.StudentObservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.School.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.School.Classday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.School.Classroom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AccomplishmentClassrooms", (string)null);
                });

            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.School.Classtime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.School.ClasstimeShortDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Timetable.Timetable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DayId", "RoomId", "TimeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ObservationTypeStudentObservation", b =>
                {
                    b.HasOne("SkorinosGimnazija.Domain.Entities.Observation.StudentObservation", null)
                        .WithMany()
                        .HasForeignKey("StudentObservationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SkorinosGimnazija.Domain.Entities.Observation.ObservationType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Accomplishments.AccomplishmentStudent", b =>
                {
                    ...
                    b.HasOne("SkorinosGimnazija.Domain.Entities.School.Classroom", "Classroom")
                        .WithMany()
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Observation.StudentObservation", b =>
                {
                    b.HasOne("SkorinosGimnazija.Domain.Entities.Observation.ObservationLesson", "Lesson")
                        .WithMany()
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkorinosGimnazija.Domain.Entities.Observation.ObservationTarget", "Target")
                        .WithMany()
                        .HasForeignKey("TargetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkorinosGimnazija.Domain.Entities.Identity.AppUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("SkorinosGimnazija.Domain.Entities.Timetable.Timetable", b =>
                {
                    b.HasOne("SkorinosGimnazija.Domain.Entities.School.Classday", "Day")
                        .WithMany()
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkorinosGimnazija.Domain.Entities.School.Classroom", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SkorinosGimnazija.Domain.Entities.School.Classtime", "Time")
                        .WithMany()
