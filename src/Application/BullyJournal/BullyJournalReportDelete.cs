...
public static class BullyJournalReportDelete
{
    ...
    public class Handler : IRequestHandler<Command, Unit>
    {
        ...
        {
            var entity = await _context.BullyJournalReports.FirstOrDefaultAsync(x => x.Id == request.Id);
            if (entity is null)
            {
            ...
            _context.BullyJournalReports.Remove(entity);
